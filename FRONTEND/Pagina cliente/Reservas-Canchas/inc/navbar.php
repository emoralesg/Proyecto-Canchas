...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">RESERVA TU CANCHA</p>
            </div>
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="index.php" class="table-cell-td">Inicio</a>
                  /*href="product.php" class="table-cell-td">Productos*/
                  <a href="comollegar.php" class="table-cell-td">Como Llegar</a>
                  <a href="reserva.php" class="table-cell-td">Reserva Ya</a>
                  <a href="eventos.php" class="table-cell-td">Ver Eventos</a>
                  <a href="quienessomos.php" class="table-cell-td">Quienes Somos</a>
                  <?php
