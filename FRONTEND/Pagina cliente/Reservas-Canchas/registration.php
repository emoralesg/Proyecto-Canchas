    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">RESERVA TU CANCHA</small></h1>
            </div>
            <p class="lead text-center">
              
            ¡Llena este formulario para formar parte de nuestros servicios y disfruta de los más grandes beneficios!
            </p>
            <div class="row">
